...
const char * const BITCOIN_CONF_FILENAME = "rincoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Rincoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Rincoin";
#else
    // Unix-like
    return pathRet / ".rincoin";
#endif
#endif
}
