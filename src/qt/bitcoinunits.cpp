...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("RIN");
    case mBTC: return QString("rins");
    case uBTC: return QString("photons");
    case SAT: return QString("rinoshi");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Rincoin");
    case mBTC: return QString("Rins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Photons (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT: return QString("Rinoshis (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
